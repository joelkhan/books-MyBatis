...
public class RoleMapperTest extends BaseMapperTest {
  ...
  public void testSelectById() {
    ...
    try {
      ...
      System.out.println("roleName is: " + role.getRoleName());
    } finally {
      // 不要忘记关闭 sqlSession
      sqlSession.close();
    }
  ...
  public void testSelectById2() {
    ...
    try {
      ...
      // roleName = 管理员
      Assert.assertEquals("管理员", role.getRoleName());
      System.out.println("roleName【testSelectById2()】 is: " + role.getRoleName());
    } finally {
      // 不要忘记关闭 sqlSession
      sqlSession.close();
    }
  ...
  public void testSelectAll() {
    ...
    try {
      ...
      System.out.println("total roles: " + roleList.size());
    } finally {
      // 不要忘记关闭 sqlSession
      sqlSession.close();
    }
